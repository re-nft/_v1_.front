  ...
  return (
    <div className="text-content copy-text">
      ...
      <div>
        <img src="assets/faq/bullet-1.png" />
        &nbsp;This is the NFT standard. There are 2 main standards out there:
        721 and 1155. The 1155 standard lets you mint semi-fungible NFTs, which
        means that you have more than one NFT that looks the same, even though,
        they would have the same id.
      </div>
      <br />
      <div>
        <img src="assets/faq/bullet-2.png" />
      ...
      <div>
        <img src="assets/faq/bullet-4.png" />
        &nbsp;For 1155 standard, this number will tell you how many copies of
        this semi-fungible NFT the lender is lending. The collateral you will
        pay will be multiplied by this number.
      </div>
      <br />
      <div>
        <img src="assets/faq/bullet-5.png" />
        &nbsp;The length of the rent. If you fail to return the NFT by the end
        of this period, the lender will be able to claim the collateral you will
        pay.
      </div>
      <br />
      <div>
      ...
      <div>
        <img src="assets/faq/bullet-7.png" />
        &nbsp;Collateral price per NFT. If this is a 721 standard, then this is
        a total collateral you have to pay. If this is 1155, then this is a per
      ...
      <div>
        ...
        field will give you the total amount payable you will send to the reNFT
        contract for escrow.
      </div>
      <br />
      <div>
        <img src="assets/faq/bullet-9.png" />
        &nbsp;If this is the first time you are renting, you will need to
        approve the payment token for reNFT. You will only need to do this once,
        per payment token. This button will change to Rent, once you have
