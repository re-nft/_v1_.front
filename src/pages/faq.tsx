  ...
  return (
    <div>
      <div className="p-8 text-2xl leading-tight text-white font-body">
        ...
        <div className="flex flex-col space-y-2">
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 px-2 bg-white bg-opacity-0 hover:bg-opacity-20 hover:cursor-pointer">
            ...
            <div className="col-span-8">
              ...
              which means that you have more than one NFT that looks the same,
              even though, they would have the same id. ReNFT protocol allows
              you to lend multiple amounts of this standard. But you need to
              understand a couple of things, before you lend such an NFT. We
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 px-2 bg-white bg-opacity-0 hover:bg-opacity-20 hover:cursor-pointer">
            ...
            <div className="col-span-8">
              ...
              number of days that your NFT can be rented out for by someone
              else. Therefore, be careful not to set it for too long, because if
              the floor price of the NFT rises, the renter may choose to not
              return the NFT. Think of lending as selling a call contract with a
              strike price of the collateral. If the floor price during the rent
              goes up to 2 ETH and you have set the collateral price at 1 ETH,
              then there is obviously a profit of 1 ETH for the renter.
              Therefore, it is important to actively monitor the market and
              update your lending when required. Another good way to manage this
              risk is to set a small max lend duration, such that it is less
              likely that the floor price goes up during the rent.
            </div>
          </div>
          <br />
          <div className="grid grid-cols-1 md:grid-cols-12 px-2 bg-white bg-opacity-0 hover:bg-opacity-20 hover:cursor-pointer">
            ...
            <div className="col-span-8">
              ...
              payments are accrued per second. If you return the NFT earlier,
              the correct amounts will be compensated back to you. Keep in mind,
              that when renter rents, they will pay both the full amount of
              rent, as well as collateral. This will go into the reNFT contract
              for escrow. In this example, the renter will have to pay 0.01 WETH
              per day to rent
              ...
              note, that the whole number cannot exceed 4 digits. This means
              that the max number is 9999.9999 and the min number is 0.0001.
            </div>
          </div>
          <br />
          <div className="grid grid-cols-1 md:grid-cols-12 px-2 bg-white bg-opacity-0 hover:bg-opacity-20 hover:cursor-pointer">
            ...
            <div className="col-span-8">
              Collateral if the standard is 1155. In this example, the
              collateral is 200 WETH. However, since the standard is 1155, the
              renter will pay 2 * 200 WETH. This is a crucial distinction versus
              721. <b>KEEP THIS IN MIND</b> when lending the 1155 standard!
            </div>
          </div>
          <br />
          <div className="grid grid-cols-1 md:grid-cols-12 px-2 bg-white bg-opacity-0 hover:bg-opacity-20 hover:cursor-pointer">
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 px-2 bg-white bg-opacity-0 hover:bg-opacity-20 hover:cursor-pointer">
            ...
            <div className="col-span-8">
              ...
              will need to approve it. Only after approval, will you be able to
              lend it. So keep this in mind, you may need to issue two
              transactions on the first time around the NFT interacts with the
              ReNFT contract.
            </div>
          </div>
          <br />
        ...
        <div>
          Head out to the RENT tab above. Pick an NFT you would like to rent.
          You will get a modal like this. Let&apos;s go through it together to
          understand what each piece of information here means.
          <div style={{ marginTop: "1em", textAlign: "center" }}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 px-2 bg-white bg-opacity-0 hover:bg-opacity-20 hover:cursor-pointer">
          ...
          <div className="col-span-8">
            ...
            this period, the lender will be able to claim the collateral you
            will pay.
          </div>
        </div>
        <br />
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 px-2 bg-white bg-opacity-0 hover:bg-opacity-20 hover:cursor-pointer">
          ...
          <div className="col-span-8">
            ...
            total collateral you have to pay. If this is 1155, then this is a
            per item collateral price. Note that you will have to pay full rent
            amount plus full collateral to rent. If you return earlier, the rent
            payment will be compensated proportionally. Collateral gets returned
            on successful return, as well.
          </div>
        </div>
        <br />
        <div className="grid grid-cols-1 md:grid-cols-12 px-2 bg-white bg-opacity-0 hover:bg-opacity-20 hover:cursor-pointer">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 px-2 bg-white bg-opacity-0 hover:bg-opacity-20 hover:cursor-pointer">
          ...
          <div className="col-span-8">
            ...
            payment token. This button will change to Rent, once you have
            approved the payment token.
          </div>
        </div>
        <br />
        <br />
        ...
        tested and peer reviewed, exercise caution, all responsibility due to
        loss bares with the users of the app.
      </div>
    </div>
  );
};
