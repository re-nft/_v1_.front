...
import { chunkArray, parseCallKey } from "../utils";
import { Call, CallListeners, CallResults } from "../types";
...
export function activeListeningKeys(
  allListeners: CallListeners | undefined,
  chainId?: number
...
export function MulticallUpdater(): null {
  const {
    multicall: { callListeners, callResults },
