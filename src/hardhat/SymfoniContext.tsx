...
import { ChiGasSaver } from "./typechain/ChiGasSaver";
import { ChiGasSaver__factory } from "./typechain/factories/ChiGasSaver__factory";
...
export const ResolverContext = React.createContext<SymfoniResolver>(
  emptyContract
);
export const RentNftContext = React.createContext<SymfoniRentNft>(
  emptyContract
);
export const FaucetContext = React.createContext<SymfoniFaucet>(emptyContract);
export const MyERC1155Context = React.createContext<SymfoniMyERC1155>(
  emptyContract
);
export const MyERC20Context = React.createContext<SymfoniMyERC20>(
  emptyContract
);
export const UtilsContext = React.createContext<SymfoniUtils>(emptyContract);
export const MyERC721Context = React.createContext<SymfoniMyERC721>(
  emptyContract
);
export const ERC1155Context = React.createContext<SymfoniERC1155>(
  emptyContract
);
export const ERC20Context = React.createContext<SymfoniERC20>(emptyContract);
export const ERC721HolderContext = React.createContext<SymfoniERC721Holder>(
  emptyContract
);
...
export interface SymfoniChiGasSaver {
  instance?: ChiGasSaver;
  factory?: ChiGasSaver__factory;
}
...
export const Symfoni: React.FC<SymfoniProps> = ({
  ...
  const [ERC721Holder, setERC721Holder] = useState<SymfoniERC721Holder>(
    emptyContract
  );
  ...
  const getRentNft = (_provider: providers.Provider, _signer?: Signer) => {
    ...
    const instance = _signer
      ? RentNft__factory.connect(contractAddress, _signer)
      : RentNft__factory.connect(contractAddress, _provider);
  ...
  const getFaucet = (_provider: providers.Provider, _signer?: Signer) => {
    let instance = _signer
      ? Faucet__factory.connect(ethers.constants.AddressZero, _signer)
      : Faucet__factory.connect(ethers.constants.AddressZero, _provider);
  ...
  const getMyERC1155 = (_provider: providers.Provider, _signer?: Signer) => {
    ...
    const instance = _signer
      ? MyERC1155__factory.connect(contractAddress, _signer)
      : MyERC1155__factory.connect(contractAddress, _provider);
  ...
  const getMyERC20 = (_provider: providers.Provider, _signer?: Signer) => {
    ...
    const instance = _signer
      ? MyERC20__factory.connect(contractAddress, _signer)
      : MyERC20__factory.connect(contractAddress, _provider);
  ...
  const getMyERC721 = (_provider: providers.Provider, _signer?: Signer) => {
    ...
    const instance = _signer
      ? MyERC721__factory.connect(contractAddress, _signer)
      : MyERC721__factory.connect(contractAddress, _provider);
  ...
  const getERC721Holder = (_provider: providers.Provider, _signer?: Signer) => {
    let instance = _signer
      ? ERC721Holder__factory.connect(ethers.constants.AddressZero, _signer)
      : ERC721Holder__factory.connect(ethers.constants.AddressZero, _provider);
